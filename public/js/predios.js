...
//             .forEach(usuario => {
//                 const option = document.createElement('option');
//                 option.value = parseInt(usuario.usr_mat); // Convert to integer
//                 option.text = `${usuario.usr_nom} ${usuario.usr_sob} (${usuario.usr_mat})`;
//                 select.appendChild(option);
//             });
//     } catch (error) {
...
//     // Resetar formulário quando o modal for aberto para "Novo Prédio"
...
//     // Manipular abertura do modal para novo prédio
//     document.getElementById('newPredioBtn').addEventListener('click', () => {
//         const modal = new bootstrap.Modal(modalElement);
//         modal.show();
//     });

//     // Carregar usuário, prédios e usuários ao iniciar
//     loadUserGreeting();
//     loadPredios();
//     loadUsuariosSelect();
// });
