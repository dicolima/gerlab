...
//                     s.sol_sts
//                 FROM solicitacoes s
//                 LEFT JOIN faculdades f ON f.fac_id = s.faculdade_id AND f.ativo = true
//                 LEFT JOIN disciplinas d ON d.dis_id = s.disciplina_id AND d.ativo = true
//                 LEFT JOIN professores p ON p.prof_id = s.professor_id AND p.ativo = true
//                 LEFT JOIN laboratorio l ON l.lab_id = s.laboratorio_id AND l.ativo = true
//                 WHERE s.sol_sts = 'Pendente' AND s.ativo = true
//                 ORDER BY s.id
//             `;
